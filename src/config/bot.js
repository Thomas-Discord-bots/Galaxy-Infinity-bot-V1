    ...
    activities: [
      {
        ...
        state: "!!🚨NEW UPDATE🚨!!: Added music system from YT, Spotify, Deezer and much more!!, Also changed bot name to 'Galaxy Infinity bot V1'",     // this is what people actually see
        type: 4,               // Custom
      },
    ],
  },
